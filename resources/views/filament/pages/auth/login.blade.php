<x-auth-split-layout :heading="$this->getHeading()" :subheading="$this->getSubheading()">
    <form wire:submit="authenticate" id="authenticate" class="grid gap-y-8 w-full">
        ...
        <div class="grid grid-cols-2 gap-4">
            <a href="{{ route('auth.google') }}" class="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700">
            ...
            <a href="{{ route('auth.apple') }}" class="flex w-full items-center justify-center gap-3 rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 dark:border-gray-700 dark:bg-gray-800 dark:text-gray-200 dark:hover:bg-gray-700">
    ...
    <div class="mt-6 flex items-center justify-between text-sm">
        ...
        <div class="text-left">
            <p>Dont have an Account?
                <a href="{{ filament()->getRegistrationUrl() }}" class="font-medium text-navy hover:text-gold hover:underline">
                    Create an account
                </a>
        ...
        <div class="text-right">
            <a href="{{ filament()->getRequestPasswordResetUrl() }}" class="font-medium text-navy hover:text-gold hover:underline">
                Forgot password?
            </a>
        </div>
        @endif
