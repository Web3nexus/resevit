        ...
        <x-filament::section>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                @foreach($templates as $template)
                    <div class="group relative bg-white dark:bg-gray-800 rounded-3xl overflow-hidden border border-gray-200 dark:border-gray-700 shadow-sm hover:shadow-xl transition-all duration-300 cursor-pointer h-full flex flex-col p-2 {{ ($selectedTemplate?->id === $template->id) ? 'ring-4 ring-primary-500/50' : '' }}"
                        wire:click="selectTemplate({{ $template->id }})">
                        <div class="aspect-[16/10] bg-gray-50 dark:bg-gray-900 relative overflow-hidden rounded-2xl border border-gray-100 dark:border-gray-700 m-2">
