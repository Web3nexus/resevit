    ...
    <section class="py-24 bg-brand-offwhite">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                {{-- Feature 1 --}}
                <div
                    class="bg-white p-8 rounded-3xl shadow-sm border border-slate-100 hover:shadow-xl hover:-translate-y-2 transition-all duration-300 group">
                    <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6">Automate bookings, reduce no-shows, and maximize table
                        turnover with AI-driven scheduling.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6">Effortlessly manage shifts, payroll, and performance with
                        integrated team tools.</p>
                </div>
                ...
                <div
                    ...
                    <p class="text-slate-600 leading-relaxed mb-6">Real-time insights into sales, customer preferences, and
                        inventory to drive profitability.</p>
                </div>
            </div>
        </div>
    </section>
