...
@php
    ...
    $config = $settings->error_pages['403'] ?? [];
    $title = $config['title'] ?? 'Access Forbidden';
    $description = $config['description'] ?? 'Sorry, you don\'t have permission to access this resource. Please contact administrator if you think this is a mistake.';
            ...
            <div class="relative flex justify-center">
                @if($image)
                    <div class="relative group">
                        <img src="{{ $image }}" alt="Error 403" class="max-h-[450px] w-auto animate-float drop-shadow-2xl">
                        <div
                ...
                @else
                    ...
                    <div class="relative flex items-center justify-center">
                        <span
                            class="text-[200px] md:text-[280px] font-black text-slate-100/50 dark:text-gray-800/20 select-none tracking-tighter leading-none">403</span>
                        <div class="absolute inset-0 flex items-center justify-center">
                            <div class="relative">
                                <i class="fa-solid fa-lock text-brand-primary text-[100px] md:text-[140px] animate-float"></i>
                                <div
