        ...
        return $schema
            ->schema([
                Section::make('Two-Factor Authentication')
                    ...
                    ->schema([
                        View::make('filament.customer.pages.auth.two-factor-status')
                            ->viewData([
                        ...
                        Actions::make([
                            Action::make('enable')
                                ...
                                ->modalContent(function () use ($user) {
                                    ...
                                    return view('filament.customer.pages.auth.two-factor-modal', [
                            ...
                            Action::make('showRecoveryCodes')
                                ...
                                ->modalContent(function () use ($user) {
                                    return view('filament.customer.pages.auth.recovery-codes-modal', [
