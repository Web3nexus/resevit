...
{
    protected $signature = 'tenants:smart-migrate {--tenants=* : The tenant(s) to migrate} {--path=* : The path(s) to the migrations files to be executed} {--realpath : Indicate any provided migration file paths are pre-resolved absolute paths} {--schema-path= : The path to a schema dump file} {--pretend : Dump the SQL queries that would be run} {--step : Force the migrations to be run so they can be rolled back individually} {--force : Force the operation to run when in production}';
